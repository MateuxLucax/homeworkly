...
if ($_SERVER['REQUEST_METHOD'] == 'GET')
{
    ...
    if ($permissao == PermissaoTarefa::PODE)
    {
        ...
        require $root . 'views/componentes/base.php';
    }
    else 
    {
        $mensagem = match($permissao) {
            ...
            default => 'Segundo o sistema, você não pode alterar essa tarefa, mas não sabemos qual o motivo<br/><small>(Cód: '.$permissao.')</small>',
        };
